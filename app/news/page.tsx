...
const newsList = [
  {
    id: 1,
    title: "态禾园2026年完成关键升级 打造观景平台与露营基地",
    category: "company",
    date: "2026-06-06",
  ...
  {
    id: 2,
    title: "态禾农业累计投资近4000万元 园区初具规模",
    category: "company",
    date: "2026-05-20",
    summary: "截至2026年，态禾园田园综合体项目累计投资近4000万元，园区基础设施与产业体系已初具规模，正处于由\"传统农业园区\"向\"农文旅融合示范区\"转型升级的关键阶段。",
  },
  {
    id: 3,
    title: "态禾农业累计带动3000余户农户增收致富",
    category: "company",
    date: "2026-04-15",
  ...
  {
    id: 4,
    title: "态禾园桃、梨、猕猴桃产品通过绿色食品认证",
    category: "company",
    date: "2025-12-10",
    summary: "园区桃、梨、猕猴桃产品均通过中国绿色食品认证，公司注册品牌商标\"态禾秋实\"，品牌与资质体系不断完善。",
  },
  {
    id: 5,
    title: "态禾农业被认定为省级农业产业化重点龙头企业",
    category: "company",
    date: "2021-12-20",
    summary: "2021年公司被认定为省级农业产业化重点龙头企业，2020年12月在新四板成功挂牌，公司发展稳健，品牌影响力持续提升。",
  },
  {
    id: 6,
    title: "态禾园打造1200亩综合性田园综合体",
    category: "tech",
    date: "2021-06-01",
    summary: "态禾园依山而建，整体呈现层次分明的山地梯田果园景观。园区总占地约1200亩，其中精品水果种植面积852.3亩，主要种植红桃、黄桃、苏翠1号梨、新玉蜜梨、樱桃等优质果品；配套建设生态水产养殖区100亩，构建\"种养结合、循环发展\"的生态农业体系。",
  },
  {
    id: 7,
